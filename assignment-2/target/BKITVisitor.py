...
class BKITVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BKITParser#var_elem.
    ...
    # Visit a parse tree produced by BKITParser#array_elem.
    ...
    # Visit a parse tree produced by BKITParser#unary_int.
    def visitUnary_int(self, ctx:BKITParser.Unary_intContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BKITParser#unary_float.
    def visitUnary_float(self, ctx:BKITParser.Unary_floatContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by BKITParser#list_else_sta.
