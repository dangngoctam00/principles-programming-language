...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_390(self):
        ...
        EndBody.
        """
        expect = Program([VarDecl(Id("a"),[1,2],ArrayLiteral([IntLiteral(123),ArrayLiteral([FloatLiteral(1e-36),FloatLiteral(1.25)])])),FuncDecl(Id("main"),[VarDecl(Id("a"),[123],None),VarDecl(Id("b"),[],None),VarDecl(Id("x"),[],None)],([],[]))])
